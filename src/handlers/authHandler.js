...
const { users, JWT_SECRET, saveUsers } = require("../data/data");
...
const registerHandler = async (request, h) => {
    ...
    users.push(newUser);
    saveUsers(); // Save users to data.json after registration
...
const editingProfileHandler = async (request, h) => {
    ...
    if (age) user.age = age;
    saveUsers(); // Save users to data.json after profile update
...
const changePasswordHandler = async (request, h) => {
    ...
    saveUsers(); // Save users to data.json after password change
